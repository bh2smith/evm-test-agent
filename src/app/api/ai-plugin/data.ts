...
export const pluginData = {
  ...
  paths: {
    "/api/tools/encode_payment": {
      get: {
        summary: "encodes signRequest for protected routes",
        description: "Returns signRequest for specified protected route.",
        operationId: "encode-payment",
        parameters: [
          { $ref: "#/components/parameters/evmAddress" },
          {
            ...
            in: "query",
            required: true,
            description: "name of tool call",
            schema: { type: "string" },
            example: "api/tools/protected/cheap",
          },
        ],
        responses: {
    ...
    "/api/tools/prices": {
      get: {
        ...
        parameters: [],
        responses: {
          "200": { $ref: "#/components/responses/X402AllRoutePayments" },
        },
      },
    },
  ...
  components: {
    ...
    responses: {
      ...
      X402AllRoutePayments: {
        description: "Payment requirements for all protected routes",
        content: {
          "application/json": {
            schema: {
              $ref: "#/components/schemas/X402AllRoutePayments",
            },
          },
        },
      },
